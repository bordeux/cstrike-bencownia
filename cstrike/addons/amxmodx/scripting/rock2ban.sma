...
public plugin_init() {
	...
	pCvar[CVAR_PERCENT] = register_cvar( "voteban_percent", "45" )
	pCvar[CVAR_BANTYPE] = register_cvar( "voteban_type", "4" )
	pCvar[CVAR_BANTIME] = register_cvar( "voteban_time", "2880" )
	pCvar[CVAR_LIMIT] = register_cvar( "voteban_limit", "3" )
	pCvar[CVAR_REASON] = register_cvar( "voteban_reason", " 3a6aHeH /voteban'om Ha %time% MuH.! Pa36aH TyT: BaIII cauT" )
