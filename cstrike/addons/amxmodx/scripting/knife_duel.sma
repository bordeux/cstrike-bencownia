...
Challenge(challenger, challenged) {
    ...
    format(menu, 1023, "%s wyzwal Cie na pojedynek nozowy!^n^nZgadzasz sie? Masz %d sekund na odpowiedz!^n^n\y1\w. Dawac go tutaj!^n\y2\w. Nie, boje sie :(", challenger_name, DECIDESECONDS)
